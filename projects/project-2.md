...
The video introduced a site called repl.it which is an IDE that you can run code in the cloud for free. After finishing the tutorial, I wanted to add more 
...
Python functions into commands for the bot. Then, the bot will recognize commands given in a Discord channel.
